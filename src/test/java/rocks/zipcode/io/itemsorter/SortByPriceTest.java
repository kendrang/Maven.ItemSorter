...
public class SortByPriceTest {
    ...
    public void test2() {
        // given
        Item item3 = new Item(3L, "TV", 90.0);
        Item item2 = new Item(4L, "Phone", 80.5);
        Item item1 = new Item(5L, "Radio", 20.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item1, item2, item3};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator2 = ( Comparator<Item>) new PriceComparator();

        // when
        Item[] actual = itemSorter.sort(comparator2);
    ...
    public void test3() {
        // given
        Item item3 = new Item(10L, "Gift for Friend", 100.0);
        Item item2 = new Item(15L, "Gift for Best Friend", 150.5);
        Item item1 = new Item(16L, "Gift for Parents", 200.0);
        Item[] itemsToSort = {item2, item1, item3};
        Item[] expected = {item3, item2, item1};
        ItemSorter itemSorter = new ItemSorter(itemsToSort);
        Comparator<Item> comparator = (Comparator<Item>) new PriceComparator();
